...
GLOBAL_LIST_INIT(ROLES_AI, list(JOB_SO, JOB_CAS_PILOT, JOB_TANK_CREW, JOB_SQUAD_LEADER, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_RTO, JOB_SQUAD_MEDIC, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MARINE))
