...
GLOBAL_LIST_INIT(cm_vending_gear_engi, list(
		...
		list("M40 MFHS grenade box", 10, /obj/item/ammo_box/magazine/nade_box/foam, null, VENDOR_ITEM_REGULAR),
		...
		list("Tactical Tools Pouch", 9, /obj/item/storage/pouch/tools/tactical/full, null, VENDOR_ITEM_REGULAR),
