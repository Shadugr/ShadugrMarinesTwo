...
/mob/living/carbon/xenomorph/sprinter
	...
	icon = 'modular/xeno_races/icons/mob/pathogen/sprinter.dmi'
	...
	icon_xeno = 'modular/xeno_races/icons/mob/pathogen/sprinter.dmi'
	icon_xenonid = 'modular/xeno_races/icons/mob/pathogen/sprinter.dmi'
	//need_weeds = FALSE
