/datum/tts_provider
	...
	/// Whether this provider supports server-side effects
	var/supports_server_effects = FALSE

/datum/tts_provider/proc/request(text, datum/tts_seed/seed, datum/callback/proc_callback, effect = 0)
	return TRUE
